...
echo("<div class='error'><div class='error-title'>Error <span class='error-code'>404</span></div><div class='error-msg'>".__('e404', true, array("\"".($UC->getLink()[count($UC->getLink())-1] == "" ? "/" : $UC->getLink()[count($UC->getLink())-1]) . "\""))."</div><img src='/res/img/errors/404.svg'></div></body></html>");
?>